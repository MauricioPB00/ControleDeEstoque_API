 ...
 */
final class Version20240404030750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE horas_calculadas ALTER user_id SET NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E2F897EAA76ED395');
        $this->addSql('ALTER TABLE horas_calculadas ALTER user_id DROP NOT NULL');
    }
}
