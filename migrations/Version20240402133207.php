 ...
 */
final class Version20240402133207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE calculo RENAME COLUMN user_id_id TO user_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D7B46581A76ED395');
        $this->addSql('ALTER TABLE calculo RENAME COLUMN user_id TO user_id_id');
